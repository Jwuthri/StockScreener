...
from backend.services.tradingview_service import get_stocks_with_filters, get_stocks_with_filters_no_post_filters, tv_cookies
from backend.models.database import Stock, PriceHistory, db_session, Base, engine
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(Path(__file__).parent / "daily_stock_update.log"),
...
def fetch_stock_list(min_price=0.25, min_volume=100000, limit=10_000):
    """
    ...
    try:
        ...
        stocks = get_stocks_with_filters_no_post_filters(
            min_price=min_price,
