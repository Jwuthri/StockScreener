...
async def register(user_data: UserCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        # Create new user
        user = User(username=user_data.username, email=user_data.email, created_at=datetime.now(), is_active=True)
        ...
        return UserResponse(username=user.username, email=user.email, created_at=user.created_at)
...
async def read_users_me(current_user: User = Depends(get_current_user)):
    ...
    return UserResponse(username=current_user.username, email=current_user.email, created_at=current_user.created_at)
